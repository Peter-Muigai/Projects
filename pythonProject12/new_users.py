...
Age: {self.age}
    ...
    def reading_login_attempts(self):
        """This reads the login attempts."""
        print(f"You have {self.login_attempts} login attempts.")

    def increment_login_attempts(self, logins):
        """This increments logging attempts by 1."""
        self.login_attempts += logins

    def reset_login_attempts(self, logins):
        """this resets login attempts to 0."""
        self.login_attempts -= logins
...
my_name.greet_user()
my_name.reading_login_attempts()
my_name.increment_login_attempts(1)
my_name.reading_login_attempts()
my_name.reset_login_attempts(1)
my_name.reading_login_attempts()

your_name.greet_user()
your_name.reading_login_attempts()
your_name.increment_login_attempts(1)
your_name.reset_login_attempts(0)